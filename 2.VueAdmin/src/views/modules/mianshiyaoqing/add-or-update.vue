<template>
	<div class="addEdit-block" :style='{"padding":"0px 3%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="邀请标题" prop="yaoqingbiaoti">
					<el-input v-model="ruleForm.yaoqingbiaoti" placeholder="邀请标题" clearable  :readonly="ro.yaoqingbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="邀请标题" prop="yaoqingbiaoti">
					<el-input v-model="ruleForm.yaoqingbiaoti" placeholder="邀请标题" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="type!='info'"  label="邀请详情" prop="yaoqingxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.yaoqingxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else-if="ruleForm.yaoqingxiangqing" label="邀请详情" prop="yaoqingxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.yaoqingxiangqing"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				yaoqingbiaoti: [
					{ required: true, message: '邀请标题不能为空', trigger: 'blur' },
				],
				qiyezhanghao: [
				],
				qiyemingcheng: [
				...
				yaoqingxiangqing: [
					{ required: true, message: '邀请详情不能为空', trigger: 'blur' },
				],
				fasongshijian: [
				],
			}
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='yaoqingbiaoti'){
							this.ruleForm.yaoqingbiaoti = obj[o];
							this.ro.yaoqingbiaoti = true;
							continue;
						}
						if(o=='qiyezhanghao'){
						...
						if(o=='yaoqingxiangqing'){
							this.ruleForm.yaoqingxiangqing = obj[o];
							this.ro.yaoqingxiangqing = true;
							continue;
						}
						if(o=='fasongshijian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yaoqingxiangqing = this.ruleForm.yaoqingxiangqing.replace(reg,'../../../springbootgvq91/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
