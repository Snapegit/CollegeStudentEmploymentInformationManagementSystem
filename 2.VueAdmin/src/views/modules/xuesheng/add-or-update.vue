	...
	<div class="addEdit-block" :style='{"padding":"0px 3%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="身份证" prop="shenfenzheng">
					<el-input v-model="ruleForm.shenfenzheng" placeholder="身份证" clearable  :readonly="ro.shenfenzheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="身份证" prop="shenfenzheng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="家庭住址" prop="jiatingzhuzhi">
					<el-input v-model="ruleForm.jiatingzhuzhi" placeholder="家庭住址" clearable  :readonly="ro.jiatingzhuzhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="家庭住址" prop="jiatingzhuzhi">
					<el-input v-model="ruleForm.jiatingzhuzhi" placeholder="家庭住址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="专业班级" prop="zhuanyebanji">
					<el-input v-model="ruleForm.zhuanyebanji" placeholder="专业班级" clearable  :readonly="ro.zhuanyebanji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="专业班级" prop="zhuanyebanji">
					<el-input v-model="ruleForm.zhuanyebanji" placeholder="专业班级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="四六级分数" prop="siliujifenshu">
					<el-input v-model="ruleForm.siliujifenshu" placeholder="四六级分数" clearable  :readonly="ro.siliujifenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="四六级分数" prop="siliujifenshu">
					<el-input v-model="ruleForm.siliujifenshu" placeholder="四六级分数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="技能证书" prop="jinengzhengshu">
					<el-input v-model="ruleForm.jinengzhengshu" placeholder="技能证书" clearable  :readonly="ro.jinengzhengshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="技能证书" prop="jinengzhengshu">
					<el-input v-model="ruleForm.jinengzhengshu" placeholder="技能证书" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='siliujifenshu'){
							this.ruleForm.siliujifenshu = obj[o];
							this.ro.siliujifenshu = true;
							continue;
						}
						if(o=='jinengzhengshu'){
							this.ruleForm.jinengzhengshu = obj[o];
							this.ro.jinengzhengshu = true;
							continue;
						}
				}
