<template>
	<div class="addEdit-block" :style='{"padding":"0px 3%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'" label="招聘编号" prop="zhaopinbianhao">
					<el-input v-model="ruleForm.zhaopinbianhao" placeholder="招聘编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.zhaopinbianhao" label="招聘编号" prop="zhaopinbianhao">
					<el-input v-model="ruleForm.zhaopinbianhao" placeholder="招聘编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="工作类型" prop="gongzuoleixing">
					<el-input v-model="ruleForm.gongzuoleixing" placeholder="工作类型" clearable  :readonly="ro.gongzuoleixing"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="upload" v-if="type!='info'&& !ro.jianliwenjian" label="简历文件" prop="jianliwenjian">
					<file-upload
						tip="点击上传简历文件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else-if="ruleForm.jianliwenjian" label="简历文件" prop="jianliwenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(121, 121, 121, 1)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.jianliwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else-if="!ruleForm.jianliwenjian" label="简历文件" prop="jianliwenjian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="投简时间" prop="toujianshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.toujianshijian" label="投简时间" prop="toujianshijian">
					<el-input v-model="ruleForm.toujianshijian" placeholder="投简时间" readonly></el-input>
				</el-form-item>
			</template>
